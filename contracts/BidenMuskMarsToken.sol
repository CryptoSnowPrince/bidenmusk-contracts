...
// File contracts/BidenMuskMarsToken.sol
...
contract BidenMuskMarsToken is ERC20, Ownable {
    constructor() ERC20("BidenMuskMars Token", "BMM$") {
        _mint(msg.sender, 200 * 10 ** 9 * 10 ** 9);
    }
